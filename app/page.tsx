...
export default function Home() {
    ...
    return (
        <div className="relative w-full h-screen overflow-hidden bg-[#181818]">
            ...
            <div className="absolute top-10 left-10 flex z-50 font-bold text-xl/5 text-shadow-lg">
                Farm<br/>
                Manangement<br/>
                Information<br/>
                System<br/>
            </div>
            <div className="absolute top-10 right-10 text-4xl font-bold text-shadow-lg">Friedland Dairy</div>
